...
import { BookArchiveSectionRenderer } from "@/components/book-archive/BookArchiveSection";
  ...
  return (
    <div className="book-archive">
      <div className="book-archive-topbar">
        <span className="book-archive-brand" style={{ fontFamily: "var(--font-display), serif" }}>
          Haunted Sweden
        </span>
        <LanguageToggle />
      </div>
      ...
      <main className="book-archive-main">
        ...
        <div className="book-archive-sections">
          {book.sections.map((section) => (
            <BookArchiveSectionRenderer key={section.kind} section={section} />
          ))}
        </div>

        <BookArchiveNextBook nextBook={book.nextBook} />
      </main>
      ...
      <footer className="book-archive-footer">
        ...
        <p className="book-archive-footer-note">
          Private investigation archive — not for public distribution.
        </p>
      </footer>
    </div>
  );
